	...
	<div id="container">
		...
		<div id="wrapper">
			<div id="content">
				...
				<li><a href="${pageContext.request.contextPath}/jblog/${id}/${postvo.category_no }/${postvo.no}">${postvo.title }</a><span>${postvo.reg_date }</span></li>
				</c:forEach>
				</ul>
		...
		<div id="navigation">
			...
			<ul>
				...
				<li><a href="${pageContext.request.contextPath}/jblog/${id}/${vo.no}">${vo.name }</a></li>
				</c:forEach>
				</ul>
		</div>
